        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_320px]">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center gap-3">
                      ...
                      <div className="join border border-base-300">
                        <button
                          type="button"
                          className="btn btn-sm join-item px-2.5"
                          onClick={() => setQty(line.productId, line.quantity - 1)}
                        >
                          <MinusIcon className="size-4" />
                        </button>

                        <span className="join-item px-3 text-sm font-medium">
                          {line.quantity}
                        </span>
                        ...
                        <button
                          ...
                          className="btn btn-sm join-item px-2.5"
                          onClick={() =>
                            setQty(line.productId, Math.min(99, line.quantity + 1))
                          }
          ...
          <aside className="card border border-base-300 bg-base-100 p-6 shadow-md">
            ...
            <p className="mt-4 text-xs text-base-content/60">
              <HeadphonesIcon className="inline size-3.5 text-primary" /> Support chat available after payment.
            </p>
          </aside>
        </div>
      )}
